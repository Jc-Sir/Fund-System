  ...
  <div class="fillcontain">
    ...
    <div class="table_container">
      ...
      >
        ...
        <el-table-column prop="date" label="创建时间" align="center" min-width="230" sortable>
        ...
        <el-table-column prop="type" label="收支类型" align="center" min-width="150"></el-table-column>

        <el-table-column prop="describe" label="收支描述" align="center" min-width="180"></el-table-column>

        <el-table-column prop="income" label="收入" align="center" min-width="100"></el-table-column>
...
<script>
import { get_profile_list, delete_profile } from "@/api/api";
